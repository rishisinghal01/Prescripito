    ...
    <div className="bg-white border border-gray-100 rounded text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll">
...

         {
            appointment.map((item,idx)=>{
                return <div className="flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr]  gap-1 items-center text-gray-500 py-3 px-6 border-b border-gray-100 hover:bg-gray-50" key={idx}>
